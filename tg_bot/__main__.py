...
It took lots of work for [my creator](t.me/bot_devloaper) to get me to where I am now, and every donation helps \
motivate him to make me even better. All the donation money will go to a better VPS to host me, and/or beer \
(see his bio!). He's just a poor student, so every little helps!
There are two ways of paying him; [Telegram](t.me/bot_devloaper), or [plus](t.me/bot_devloaper)."""
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="➕ Add me to your group ➕", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 More bot ", url="https://t.me/tobot_list")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/run_gram"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/rungram")],
                     [InlineKeyboardButton(text="👩‍💻 MY DEV", url="https://t.me/rungram_bot"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
